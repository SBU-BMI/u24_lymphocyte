...
def split_validation(classn, valid_num):
    ...
    pickle.dump([param_values, X_train, y_train, X_val, y_val, X_test, y_test], open("model/snapshot_{}.pkl".format(valid_num), 'w'));
    # Testing
...
def main():
    ...
    for v in range(split_n):
        Er, Pr, Or, Tr = split_validation(classn, v);
