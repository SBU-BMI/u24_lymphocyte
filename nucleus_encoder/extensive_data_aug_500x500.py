...
def data_aug_img(img, mu, sigma, deterministic=False, idraw=-1, jdraw=-1, APS=500, PS=224):
    # rotate small degree
...
def data_aug(X, mu, sigma, deterministic=False, idraw=-1, jdraw=-1, APS=500, PS=224):
