...
def cross_validation(train_func, test_func, n_binaryclassifier, fold_id, network, param_set):
    # load data
    ...
    image_array, groundtruth_array, prediction_array, _, _, _, _, _ = exc_test(test_func, X_test, a_test, y_test);
...
def main():
    ...
    # run training
    cross_validation(train_func, test_func, n_binaryclassifier, fold_id, network, all_param);
