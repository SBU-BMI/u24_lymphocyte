...
from smthact import SumLayer, SmthAct2Layer
...
def make_training_functions(network_layers, input_var, aug_var, target_var, stack_params, weight_decay):
    ...
    updates = lasagne.updates.nesterov_momentum(loss, params, learning_rate = 0.000005, momentum = 0.95);
    stack_updates = lasagne.updates.nesterov_momentum(loss, stack_params, learning_rate = 0.000005, momentum = 0.95);
