function [pred, necr, binary_truth, tumor_im, notum_im, calc_width, calc_height, tot_width, tot_height] = get_labeled_im(weight_file, mark_file, pred_file, tot_width, tot_height)

clusterPointsDisPos = 0.006;
clusterPointsDisNeg = 0.006;
timestampDis = 1000;
