...
def split_validation(classn, valid_num):
    ...
    train_round(5,  network, valid_num, new_params_train_fn, val_fn, classn, X_train, a_train, y_train, X_test, a_test, y_test);
    LearningRate.set_value(np.float32(0.01*LearningRate.get_value()));
