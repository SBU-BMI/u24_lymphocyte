...
curl -X GET "http://${MONGODB_HOST}:${MONGODB_PORT}/?limit=1000000&db=${CTYPE}&find=\{\"provenance.analysis.execution_id\":\"humanmark\",\"provenance.image.case_id\":\"${CASE_ID}\",\"properties.annotations.username\":\"${USERNAME}\"\}" \
