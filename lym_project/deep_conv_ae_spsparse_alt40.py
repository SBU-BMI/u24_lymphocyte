...
def build_autoencoder_network():
    ...
    layer = batch_norm(layers.Conv2DLayer(layer, 240,  filter_size=(3,3), stride=1, pad='same', nonlinearity=leaky_rectify));
    layer = batch_norm(layers.Conv2DLayer(layer, 240,  filter_size=(1,1), stride=1, pad='same', nonlinearity=leaky_rectify));
    ...
    layer = batch_norm(layers.Conv2DLayer(layer, 480,  filter_size=(1,1), stride=1, pad='same', nonlinearity=leaky_rectify));
    ...
    layer = batch_norm(layers.Deconv2DLayer(layer, 480, filter_size=(1,1), stride=1, crop='same', nonlinearity=leaky_rectify));
    ...
    layer = batch_norm(layers.Deconv2DLayer(layer, 240, filter_size=(1,1), stride=1, crop='same', nonlinearity=leaky_rectify));
    layer = batch_norm(layers.Deconv2DLayer(layer, 240, filter_size=(3,3), stride=1, crop='same', nonlinearity=leaky_rectify));
